# BWA-Form — read before doing anything

> ✅ **This is the CANONICAL home for BWA-Form.** All serious DSP, IP, and
> process for this plugin live **here**, in `~/Developer/BWA-Form/`. Author here — always.
>
...
> changes. This file deliberately holds only what is specific to BWA-Form; every
...
4. **`docs/MARKET-PAIN-AND-ATTACKS.md`** — the row for **BWA-Form**; internalize the pain + attack before any DSP.
...
Then cut a GitHub Release here (`vmcguire/BWA-Form`) and attach the notarized `BWA-Form.vst3`.
