...
> Do all work in the monorepo: **`~/Developer/bwa-fx-ecosystem/BWA-Form/`**
...
```bash
git subtree push --prefix=BWA-Form git@github.com:vmcguire/BWA-Form.git main
```

Then cut a GitHub Release in this mirror and attach the notarized `BWA-Form.vst3`.
