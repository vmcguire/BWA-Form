...
Emotion-shaped song scaffold generator. Genre + duration + energy curve → intro/verse/chorus/bridge/outro.
...
BWA-Form generates an emotion-shaped song scaffold. Pick a genre, a duration, an energy curve; Form produces a structured timeline with intro / verse / chorus / bridge / outro section boundaries marked. Music fills the story.

At each section boundary, Form auto-suggests Roll / Fill / Transition placements consumed downstream in Stage 6. Reads shared/emotion/ — the energy curve and section character are shaped by the project's emotion.
...
BWA-Form ships on **two surfaces** — same DSP, different UI:
...
🔴 Not built. Stub repo. Depends on shared/emotion/ + shared/groove/. Build target: Phase E3.

## Releases

Versioned `.vst3` builds for macOS land in this repo's
[Releases](https://github.com/vmcguire/BWA-Form/releases). Build from
